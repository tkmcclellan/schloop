...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'sourceControl': PropertySchema(
      id: 2,
      name: r'sourceControl',
      type: IsarType.object,
      target: r'SourceControl',
    )
  },
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'SourceControl': SourceControlSchema},
  getId: _userGetId,
...
int _userEstimateSize(
  ...
  {
    final value = object.sourceControl;
    if (value != null) {
      bytesCount += 3 +
          SourceControlSchema.estimateSize(
              value, allOffsets[SourceControl]!, allOffsets);
    }
  }
  return bytesCount;
}
...
void _userSerialize(
  ...
  writer.writeObject<SourceControl>(
    offsets[2],
    allOffsets,
    SourceControlSchema.serialize,
...
User _userDeserialize(
  ...
  object.sourceControl = reader.readObjectOrNull<SourceControl>(
    offsets[2],
    SourceControlSchema.deserialize,
    allOffsets,
  );
  return object;
}
...
P _userDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readStringOrNull(offset)) as P;
    case 2:
      return (reader.readObjectOrNull<SourceControl>(
        offset,
        SourceControlSchema.deserialize,
        allOffsets,
      )) as P;
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> sourceControlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'sourceControl',
      ));
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> sourceControlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'sourceControl',
      ));
...
extension UserQueryObject on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> sourceControl(
      FilterQuery<SourceControl> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'sourceControl');
    });
  }
}
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, SourceControl?, QQueryOperations> sourceControlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sourceControl');
    });
  }
}
